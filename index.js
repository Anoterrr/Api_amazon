...
app.get('/', (req, res) => {
    res.send('Welcome to Amazon Scraper API. (Remindid that you need a api_key to procide with uses of the api) Have fun!');
});

// GET Product Details
app.get('/product/:productId?api_key=', async(req, res) => {
